...
public static class AuthSeedService
{
    ...
    private static readonly string[] DefaultUserPermissions =
    {
        ...
        Permissions.SalesReturnRead, Permissions.SalesReturnCreate, Permissions.SalesReturnUpdate,
        ...
        Permissions.SupplierCreditNoteRead, Permissions.SupplierCreditNoteCreate, Permissions.SupplierCreditNoteUpdate,
