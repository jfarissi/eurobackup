...
- Create Angular project with ng: `ng new backup.web.api.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`backup.web.api.client.esproj`).
