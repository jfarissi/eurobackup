...
const FR: Dict = {
  ...
  'dashboard.kpi.products': 'Produits ERP',
  ...
  'compare.empty.companyHint': 'Aucun document pour la société « {company} ». Utilisez le sélecteur de société en haut — les documents parsés sont sur « Euro Brico ».',
...
const NL: Dict = {
  ...
  'dashboard.kpi.products': 'ERP-producten',
  ...
  'compare.empty.companyHint': 'Geen documenten voor vennootschap « {company} ». Schakel naar « Euro Brico » via de selector bovenaan.',
...
const EN: Dict = {
  ...
  'dashboard.kpi.products': 'ERP products',
  ...
  'compare.empty.companyHint': 'No documents for company « {company} ». Switch to « Euro Brico » in the top selector (parsed documents are attached there).',
