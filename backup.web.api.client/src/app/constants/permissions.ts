...
export const RoutePermissions: Record<string, PermissionCode[]> = {
  ...
  '/accounting/lettrage': [Permissions.AccountingRead],
  '/accounting/reports': [Permissions.AccountingRead],
  '/accounting/vat': [Permissions.AccountingRead],
  '/accounting/closing': [Permissions.AccountingRead],
  '/accounting/bank-reconciliation': [Permissions.AccountingRead],
  '/accounting/exports': [Permissions.AccountingRead],
  '/accounting/fixed-assets': [Permissions.AccountingRead],
  '/accounting/payroll': [Permissions.AccountingRead],
  '/accounting/ocr': [Permissions.AccountingRead],
  '/accounting/cabinet': [Permissions.AccountingRead],
...
export const PermissionCategories: PermissionCategory[] = [
  ...
  },
  {
    ...
    sections: [
      { label: 'admin.perm.sec.accounting', permissions: [Permissions.AccountingRead, Permissions.AccountingCreate, Permissions.AccountingValidate] },
      ...
      { label: 'admin.perm.sec.accountingCabinet', permissions: [Permissions.AccountingCabinet] },
    ],
  },
  {
    id: 'settings',
...
const PermissionActionLabels: Record<string, string> = {
  ...
  Validate: 'admin.perm.action.Validate',
  ...
  Cabinet: 'admin.perm.action.Cabinet',
