...
const MAIN_NAV_ITEMS: NavItem[] = [
  ...
  { path: '/accounting/lettrage', labelKey: 'nav.lettrage', tabLabelKey: 'nav.lettrage', icon: 'compare_arrows', titleKey: 'nav.title.lettrage' },
  { path: '/accounting/reports', labelKey: 'nav.accountingReports', tabLabelKey: 'nav.accountingReports', icon: 'assessment', titleKey: 'nav.title.accountingReports' },
  { path: '/accounting/vat', labelKey: 'nav.vatDeclaration', tabLabelKey: 'nav.vatDeclaration', icon: 'receipt', titleKey: 'nav.title.vatDeclaration' },
  { path: '/accounting/closing', labelKey: 'nav.closing', tabLabelKey: 'nav.closing', icon: 'lock', titleKey: 'nav.title.closing' },
  { path: '/accounting/bank-reconciliation', labelKey: 'nav.bankReconciliation', tabLabelKey: 'nav.bankReconciliation', icon: 'account_balance', titleKey: 'nav.title.bankReconciliation' },
  { path: '/accounting/exports', labelKey: 'nav.accountingExports', tabLabelKey: 'nav.accountingExports', icon: 'file_download', titleKey: 'nav.title.accountingExports' },
  { path: '/accounting/fixed-assets', labelKey: 'nav.fixedAssets', tabLabelKey: 'nav.fixedAssets', icon: 'precision_manufacturing', titleKey: 'nav.title.fixedAssets' },
  { path: '/accounting/payroll', labelKey: 'nav.payroll', tabLabelKey: 'nav.payroll', icon: 'payments', titleKey: 'nav.title.payroll' },
  { path: '/accounting/ocr', labelKey: 'nav.ocr', tabLabelKey: 'nav.ocr', icon: 'document_scanner', titleKey: 'nav.title.ocr' },
  { path: '/accounting/cabinet', labelKey: 'nav.cabinet', tabLabelKey: 'nav.cabinet', icon: 'business_center', titleKey: 'nav.title.cabinet' },
