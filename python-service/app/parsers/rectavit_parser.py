...
from . import rectavit

logger = logging.getLogger(__name__)


class RectavitParser(BaseParser):
    """Parser pour les factures Rectavit N.V."""

    def __init__(self, pdf_path: str):
        super().__init__(pdf_path)
        try:
            self.parsed_result = rectavit.parse(self.pdf_raw)
        except Exception as e:
            logger.error("Erreur lors du parsing Rectavit: %s", e)
